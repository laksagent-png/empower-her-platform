  ...
  return (
    <footer className="bg-foreground py-12">
      <div className="container text-center space-y-6">
        <p className="font-heading text-2xl font-bold text-primary-foreground">Aagaj</p>
        <p className="text-primary-foreground/60 text-sm max-w-md mx-auto">
          Empowering women through education, skill development, and community support across India.
        </p>
        ...
        <p className="text-primary-foreground/40 text-xs flex items-center justify-center gap-1">
          Made with <Heart size={12} className="text-primary" /> by Aagaj Foundation © 2026
        </p>
      </div>
    </footer>
  );
