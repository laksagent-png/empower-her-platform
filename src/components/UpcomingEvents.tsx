                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="space-y-1.5 mb-3 text-sm text-muted-foreground">
                      ...
                      {event.time && <div className="flex items-center gap-2"><Clock size={14} /> {event.time}</div>}
                      {event.venue && (
                        <div className="flex items-center gap-2">
                          <MapPin size={14} />
                          <a href={event.venueLink} target="_blank" rel="noopener noreferrer" className="underline hover:text-primary transition-colors">
                            {event.venue}
                          </a>
                        </div>
                      )}
                    ...
                    <div className="flex gap-3 mt-auto">
                      <a
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg text-sm font-semibold min-h-[48px] transition-opacity ${
                          isClosed ? "bg-muted text-muted-foreground cursor-not-allowed" : "gradient-warm text-primary-foreground hover:opacity-90"
                        }`}
