...
const initialEvents: Event[] = [
  ...
  {
    id: "4",
    title: "Legal Rights Awareness Drive",
    startDateTime: new Date("2026-05-20T10:00:00").getTime(),
    endDateTime: new Date("2026-05-20T14:00:00").getTime(),
    venueName: "District Court Campus, Bhopal",
    venueUrl: "https://maps.google.com/?q=District+Court+Bhopal",
    description: "Know your legal rights — property, domestic violence laws, and free legal aid services available for women.",
    status: EventStatus.ONLINE,
    registrationUrl: "https://forms.google.com",
    coverImageUrl: eventFinance,
    hostName: "Aagaj Foundation",
  ...
  },
  {
    ...
    startDateTime: new Date("2026-06-08T09:00:00").getTime(),
    endDateTime: new Date("2026-06-08T17:00:00").getTime(),
    venueName: "IIT Campus, Kanpur",
    venueUrl: "https://maps.google.com/?q=IIT+Kanpur",
    description: "Connect with top employers, attend skill-building sessions, and explore career paths in science and technology.",
    status: EventStatus.ONLINE,
    registrationUrl: "https://forms.google.com",
    coverImageUrl: eventDigital,
    hostName: "Aagaj Foundation",
  ...
  },
  {
    ...
    startDateTime: new Date("2026-06-22T10:00:00").getTime(),
    endDateTime: new Date("2026-06-22T13:00:00").getTime(),
    venueName: "Seva Sadan, Varanasi",
    venueUrl: "https://maps.google.com/?q=Seva+Sadan+Varanasi",
    description: "Interactive workshop on stress management, mindfulness, and emotional well-being for women of all ages.",
    status: EventStatus.FILLING_FAST,
    registrationUrl: "https://forms.google.com",
  ...
  {
    id: "7",
    title: "Handicraft & Artisan Skill Camp",
    startDateTime: new Date("2026-07-10T08:00:00").getTime(),
    endDateTime: new Date("2026-07-10T16:00:00").getTime(),
    venueName: "Crafts Museum, Jaipur",
    venueUrl: "https://maps.google.com/?q=Crafts+Museum+Jaipur",
    description: "Learn traditional and modern handicraft techniques to build a sustainable livelihood from home.",
    status: EventStatus.ONLINE,
    registrationUrl: "https://forms.google.com",
